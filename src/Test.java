 ...
 *
 *
 * @ Author Kevin Adamczewski, Hakan Tanis, Jonas Litmeyer
 */
public class Test

{
    ...
    public ArrayList<Node> computeNextNodes(Node source, ArrayList<Edge> edgelist)                        // Berechnung von naechsten Knoten
    {

        ArrayList<Node> nextNode = new ArrayList<Node>();                                                //Zeichnung zeigen
