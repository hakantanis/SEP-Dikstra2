...
public class PerfectLineManipulator extends Application {
	...
	public void start(final Stage secondStage) throws Exception {
		...
		generate.setOnAction(e ->  {
			hO.initOne();
              Button btn1 = new Button("next Step");
              AnchorPane aP = new AnchorPane();
              aP.getChildren().add(btn1);
              Scene s= new Scene(aP, 300,300);
              secondStage.setScene(s);
              btn1.setOnAction(f -> {secondStage.setScene(s);});
		...
		Example1.setOnAction(e ->  {
		    ...
		    hO.initOne();
              Button btn1 = new Button("Example1");
              AnchorPane aP = new AnchorPane();
              aP.getChildren().add(btn1);
              Scene s= new Scene(aP, 300,300);
              secondStage.setScene(s);
		...
		Example2.setOnAction(e ->  {
		    ...
		    hO.initTwo();
              ...
              Button btn1 = new Button("Example2");
              AnchorPane aP = new AnchorPane();
              aP.getChildren().add(btn1);
              Scene s= new Scene(aP, 300,300);
              secondStage.setScene(s);
		...
		shortestPath.setOnAction(e -> {
		    ...
		    dA.computeNextNodes(startNode, hO.edges,hO.nodes);
              Button btn1 = new Button("show shortest Path");
              AnchorPane aP = new AnchorPane();
              aP.getChildren().add(btn1);
              Scene s= new Scene(aP, 300,300);
              secondStage.setScene(s);
		...
		if(colorForNodeOrEdge instanceof Node)
          ...
          else
          {
              ...
              BoundLine boundLine =  edge2BoundLine.get(edge);
              boundLine.setStroke(Color.YELLOW);
              group.getChildren().add(boundLine);
          }
