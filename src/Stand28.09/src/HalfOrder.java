...
public class HalfOrder
{
	...
	public void init()
	{
		nodes = createNodelistExampleRandom();
	 ...
	 */
	public ArrayList<Edge> createEdgelistRandom(ArrayList<Node> nodelist)
	{
	...
	public ArrayList<Edge> createEdgelistForExampleTwo(ArrayList<Node> nodelist)
	{
		...
		edgelist.get(7).setSource(nodelist.get(4));
		...
		edgelist.get(7).setSource(nodelist.get(6));
		edgelist.get(7).setDestination(nodelist.get(7));
	 ...
	 */
	public ArrayList<Node> createNodelistExampleRandom()
	{
